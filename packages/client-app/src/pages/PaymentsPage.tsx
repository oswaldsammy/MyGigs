...
export const PaymentsPage = () => (
  <div className="mx-auto max-w-lg px-6 py-16">
    <div className="rounded-2xl bg-elev p-8 text-center shadow-sm">
      ...
      <Link to="/bookings" className="mt-6 inline-block rounded-lg bg-brand-400 text-black px-4 py-2 text-sm font-medium text-white">
        Go to my bookings
      </Link>
    </div>
  </div>
