  ...
  return (
    <header className="border-b bg-elev">
      <div className="mx-auto flex max-w-6xl items-center justify-between px-6 py-4">
        <Link to="/" className="text-xl font-bold text-brand-400">MyGigs</Link>
        <nav className="flex items-center gap-6 text-sm">
          <Link to="/search" className="hover:text-brand-400">Browse</Link>
          {user && <Link to="/bookings" className="hover:text-brand-400">Bookings</Link>}
